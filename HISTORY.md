...
2.1.3 (2022-09-09)
------------------
- Release: version 2.1.3. [lhdamiani]
- Complete removal of no restore all button fix. [lhdamiani]
- Update docker img for the softioc tests. [Leonardo Hax Damiani]
- Merge branch 'main' of
  https://github.com/paulscherrerinstitute/snapshot into main.
  [lhdamiani]
- Update lint.yml. [Leonardo Hax Damiani]
- Fix code style issues with Black. [Lint Action]
- Lint fix auto true. [Leonardo Hax Damiani]


2.1.2 (2022-09-05)
------------------
- Release: version 2.1.2. [lhdamiani]
- Selected row background color blue. [lhdamiani]
- No restore all help msg. [Leonardo Hax Damiani]


2.1.1 (2022-08-29)
------------------
- Release: version 2.1.1. [lhdamiani]
- Lint fix formating. [lhdamiani]
- Merge branch 'main' of
  https://github.com/paulscherrerinstitute/snapshot into main.
  [lhdamiani]
- Update restore.py. [Leonardo Hax Damiani]
- No restore all flag feature. [lhdamiani]
- No restore all flag in json parser. [lhdamiani]
- Feature for no restore all button flag. [lhdamiani]
- Update meta.yaml. [Leonardo Hax Damiani]
- Conda-forge channels to fix build. [Leonardo Hax Damiani]
- Merge branch 'main' of
  https://github.com/paulscherrerinstitute/snapshot into main.
  [lhdamiani]
- Bugfix multiple or bars in rgx filter. [Leonardo Hax Damiani]
- Release: version 2.1.0. [lhdamiani]
- Update conda_publish.yaml. [Leonardo Hax Damiani]
- Useful badges in readme. [Leonardo Hax Damiani]
